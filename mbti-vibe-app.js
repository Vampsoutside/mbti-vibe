...
/* Explicit globals for inline onclick (Safari-safe) */
...
window.doTwitterShare = doTwitterShare;
window.doCopyShare = doCopyShare;
window.doDownloadCard = doDownloadCard;
window.refreshSongs = refreshSongs;
window.shuffleSongs = shuffleSongs;
window.togglePlayerPause = togglePlayerPause;
window.setPlayerVolume = setPlayerVolume;
window.likeMovie = likeMovie;
window.dislikeMovie = dislikeMovie;
window.playSong = playSong;
window.debugRandomType = debugRandomType;
console.log('[MBTI Vibe] app ready');
